...
public class PlayerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        visualizers.add(new Ntctk4RectangelVisualizer());
    ...
    private void openMedia(File file) {
        ...
        try {
            ...
            mediaPlayer.setAudioSpectrumListener((double timestamp, double duration, float[] magnitudes, float[] phases) -> {
                ...
                handleTimeUpdate(timestamp, duration, magnitudes, phases);
            });
    ...
    private void handleTimeUpdate(double timestamp, double duration, float[] magnitudes, float[] phases){
        Duration ct = mediaPlayer.getCurrentTime();
        currentText.setText(ct.toString());
    ...
    private void handleUpdate(double timestamp, double duration, float[] magnitudes, float[] phases) {
        ...
        if("Ntctk4 Rectangle Visualizer" != currentVisualizer.getName()){
                mediaPlayer.setAudioSpectrumInterval(updateInterval);
            }
        
        else{
            mediaPlayer.setAudioSpectrumInterval(myUpdate);
        }
